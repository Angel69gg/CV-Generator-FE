    ...
    return (
            ...
            <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                <div className="mb-4">
                    ...
                    {t("login.usuario")} {/* esta linea nos genera la traduccion del texto */}
                    </label>
                ...
                <div className="mb-6">
                    ...
                    {t("login.contrasena")} {/* esta linea nos traduce el texto contraseña */}
                    </label>
                ...
                <div className="flex items-center justify-between">
                    ...
                    {t("login.iniciar")} {/* este texto traduce el boton */}
                    </Button>
                </div>
            </div>
    )
